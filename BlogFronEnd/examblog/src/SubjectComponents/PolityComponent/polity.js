...
export function Polity() {
  ...
  useEffect(() => {
    fetch("http://127.0.0.1:8000/ExamApp/categoryList/polity/")
  ...
  return (
    <div className="container-sm">
      <div className="jumbotron shadow rounded bg-light mt-3">
        <div className="container">
          <h3 className="ps-1 pt-2 title" id="Politytitle">{subjectName}</h3>
            <hr />
              <div className="row">
      ...
      <div className="container pt-3">
        <div className="row">
          <div className="jumbotron shadow bg-light">
            <div className="container">
              <h5>
                <Link className="link-dark link-underline-light link-offset-2 link-underline-opacity-100-hover text-nowrap" to="/polityNotes">
                  Notes
                </Link>
              </h5>
            </div>
