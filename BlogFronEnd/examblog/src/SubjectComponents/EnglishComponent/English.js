...
import "../EnglishComponent/English.css"
...
export function English(){
    ...
    useEffect(() => {
        fetch("http://127.0.0.1:8000/ExamApp/categoryList/english/")
    ...
    return(
        <div className="container-sm">
            <div className="jumbotron shadow bg-light mt-3 rounded-top">
            ...
            <div className="container-sm pt-3">
                <div className="row">
                    <div className="jumbotron shadow bg-light round">
